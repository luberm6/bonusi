...
} from "./src/app/entrypoint/session-bridge";
...
import { mobileEnv } from "./src/shared/config/mobile-env";
import { mobileTokens, mobileTypography } from "./src/shared/design/tokens";
  ...
  return (
    <View style={styles.centeredShell}>
      <GlassCard elevated animated style={styles.loginCard}>
        ...
        <Text style={styles.loginSubtitle}>Используйте рабочую учетную запись, чтобы открыть бонусы, визиты и чат.</Text>
